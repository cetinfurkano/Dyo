...
import { COLUMNS } from "./PublisherColumns";
          ...
          <div className="col-md-12 main-datatable">
            <div className="card_body">
              ...
              <div className="overflow-x">
                ...
                <FormModal show={show} setModalShow={setModalShow} registerText="Yayınevi Kaydı">
                 <PublisherInput setModalShow={setModalShow} setContracts={setContracts}/>
                </FormModal>
              </div>
            </div>
          </div>
